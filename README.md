...
### Linter installation
Before using this plugin, you must ensure that `htmllint` is installed on your system. To install `htmllint`, do the following:

1. Install [Node.js](http://nodejs.org) (and [npm](https://github.com/joyent/node/wiki/Installing-Node.js-via-package-manager) on Linux).

1. Install `htmllint` by typing the following in a terminal:
   ```
...
Once you have installed and configured `htmllint`, you can proceed to install the SublimeLinter-contrib-htmllint plugin if it is not yet installed.
...
1. When the plugin list appears, type `htmllint`. Among the entries you should see `SublimeLinter-contrib-htmllint`. If that entry is not highlighted, use the keyboard or mouse to select it.
